...
class Recognizer(AudioSource):
    ...
    def recognize_google_cloud(self, audio_data, credentials_json=None, language="en-US", speech_contexts: List[speech_v1p1beta1.SpeechContext] = None, show_all=False) -> Union[speech_v1p1beta1.RecognizeResponse, str]:
        """
        ...
        if credentials_json is not None:
            client = speech_v1p1beta1.SpeechClient.from_service_account_json(credentials_json)
        else:
        ...
        audio = speech_v1p1beta1.RecognitionAudio(content=flac_data)
        ...
        config = speech_v1p1beta1.RecognitionConfig(**config)
